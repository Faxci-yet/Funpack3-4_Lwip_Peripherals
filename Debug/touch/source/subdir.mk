...
touch/source/%.o: ../touch/source/%.c touch/source/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-touch-2f-source

clean-touch-2f-source:
	-$(RM) ./touch/source/nt.d ./touch/source/nt.o

.PHONY: clean-touch-2f-source
